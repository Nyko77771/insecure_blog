...
class Blog():
    ...
    def db_save(self):
        ...
        try:
            ...
            if blog_id:
                ...
                print(f"Unable to save blog.")
                return None
        except Exception as e:
            print(f"An exception occured while saving blog.")
            return None
    ...
    def update(self):
        ...
        try:
            ...
            print(f"An exception occured while updating blog")
            return False
    ...
    def get_all_user_blogs(username):
        ...
        try:
            ...
            if result:
                ...
                print("Blog not retrieved")
                return None
        except Exception as e:
            print("An exception occured while getting blogs.")
            return None
    ...
    def get_blog_by_id(search_id):
        ...
        try:
            ...
            if result:
                print("Found blog by id.")
                return result
            else:
                print("Blog is not found by given id")
                return None
        except Exception as e:
            print("An exception occured while getting a blog.")
            return None
    ...
    def search(search_word):
        ...
        try:
            ...
            print("An exception occured while searching")
            return None
